package edu.jhu.cs.pl.group18.CurseOfMalphamondModel.Card.MonsterCards;
...
/**
 * This is the Marathon monster card which allows the player to:
 * Move forward 8 tiles.
 * @author Vincent Yan
 *
 */
public class Marathon extends DuringTurnCard {

	@Override
	public CardType getCardType() {
		return CardType.MONSTER_CARD;
	}
	...
	public String getDescription() {
		return " moves forward 6 tiles!\n";
	}

	@Override
	public void play(CurseOfMalphamondModelImpl model, int choice) {
		(new MoveNumTilesAction(8, model.getCurrentActivePlayer())).act();
	}
